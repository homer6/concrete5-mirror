<?php   defined('C5_EXECUTE') or die(_("Access Denied.")); ?>
	...
	<a href="javascript:void(0)" <?php   if ($replaceOnUnload) { ?>onclick="location.href='<?php  echo DIR_REL?>/index.php?cID=<?php  echo $c->getCollectionID()?>'; return true" class="ccm-button-left cancel" <?php   } else { ?> class="ccm-dialog-close ccm-button-left cancel"<?php   } ?>><span><em class="ccm-button-close"><?php  echo t('Cancel')?></em></span></a>
