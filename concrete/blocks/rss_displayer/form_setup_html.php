...
<table id="rssDisplayerSetup" width="100%">
	...
	<tr>
		<th>Display:</th>
		<td>
			<input name="showSummary" type="radio" value="0" <?php echo (!$rssObj->showSummary)?'checked':''?>>Only Titles&nbsp; <br>
			<input name="showSummary" type="radio" value="1" <?php echo ($rssObj->showSummary)?'checked':''?>>Titles & Summary
		</td>
	</tr>
	<tr>
